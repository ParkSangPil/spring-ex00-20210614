...
$(function(){
	...
	$("#member-info-input2, #member-info-input4").keyup(function(){
		...
		if(pw1 != pw2){
			...
			if(pw1 == ""){
				$("#member-info-password-message").text("패스워드를 입력해 주세요.");
			}else{				
	...
	<div class="row justify-content-center mt-3">
		<div class="col-8">
			<form id="member-info-form1" method="post" action="${appRoot }/member/modify">
				...
				<button type="submit" class="btn btn-secondary" id="member-info-modify-btn1" disabled="disabled">정보 수정</button>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button id="old-password-modal-btn" type="button" class="btn btn-danger">확인</button>
			</div>
		</div>
	</div>
</div>
